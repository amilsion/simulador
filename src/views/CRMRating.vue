              ...
              <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                ...
                <div class="flex flex-col gap-4">
                  <div>
                    ...
                    <input v-model="form.name" type="text" placeholder="Ex.: Cliente" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow" />
                  </div>
                  <div>
